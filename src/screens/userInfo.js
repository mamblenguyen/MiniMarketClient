...
import CustomerUpdateScreen from '../components/UserInfo/CustomerUpdateScreen';
// import CustomerUpdateScreen from '../components/Contact/ContactForm';
        ...
        <section className="max-w-screen-xl py-24 mx-auto px-6  overflow-y-hidden">
            ...
            <Bounce left>
                <div className="flex flex-col items-center space-x-2 pb-4">
                    <h1 className="text-gray-700 poppins text-3xl">Thông Tin Người Dùng
